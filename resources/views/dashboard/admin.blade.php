        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl shadow-md p-6 text-white relative overflow-hidden">
                    ...
                    <p class="text-emerald-100 font-medium">Invoice Terbayar</p>
                ...
                <div class="bg-gradient-to-br from-rose-500 to-red-600 rounded-2xl shadow-md p-6 text-white relative overflow-hidden">
                    ...
                    <p class="text-rose-100 font-medium">Invoice Belum Terbayar</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                <div class="p-6 border-b border-slate-100 flex justify-between items-center">
                    <h3 class="font-bold text-lg text-slate-800">Proyek Terbaru</h3>
                    ...
                    <table class="w-full text-sm text-left">
                        <thead class="bg-slate-50 text-slate-500">
                            <tr>
                                ...
                                <th class="py-3 px-6 font-medium">Klien</th>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="py-8 text-center text-slate-500">Tidak ada proyek terbaru.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
